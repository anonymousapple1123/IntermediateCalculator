...
public:
    // Constructor for two complex numbers (real_1 + imaginary_1i and real_2 + imaginary_2i)
    ...
    // Constructor for one complex number (real_1 + imaginary_1i), second complex is considered 0
    ComplexNumber(T real_1, T imaginary_1)
        : real_1(real_1), imaginary_1(imaginary_1), real_2(0), imaginary_2(0) {}
